...
#define STRING_CONFIG_H_AUTHOR "LKotum" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "4MAX(TMC2208, SKR2.0B)"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.12018, 80.10413, 397.14058, 386 }
